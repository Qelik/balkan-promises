...
const TournamentProgram = () => {
    return (
        <>
            <div className='tournamentProgramWrapper py-5'>
                ...
                <div className='tournamentProgramList'>
                    <div className='day'>
                        ...
                        <p>13:00 - 14:00 &nbsp; &nbsp; Acomodation at the hotel</p>
                    ...
                    <div className='day'>
                        <h2>DAY 2</h2>
                        <p>09:00 &emsp;&emsp;&emsp;&emsp; Continuation of the tournament with the group competition.</p>
                        <p>16:00 &emsp;&emsp;&emsp;&emsp; Continuation of group matches.</p>
                    </div>
                    <div className='day'>
                        <h2>DAY 3</h2>
                        <p>09:00 &emsp;&emsp;&emsp;&emsp; Continuation of the tournament with the group competition.</p>
                    ...
                    <div className='day'>
                        ...
                        <p>13:00 &emsp;&emsp;&emsp;&emsp; Return. Hotel accommodation on the first day starts with dinner and departure on the fourth day with lunch.</p>
                    </div>
                </div>
            </div>
        </>
